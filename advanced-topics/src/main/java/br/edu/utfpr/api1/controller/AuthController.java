...
import br.edu.utfpr.api1.dto.AuthRequest;
...
public class AuthController {
    ...
    @Operation(summary = "Login", description = "Realiza o login no Cognito e retorna os tokens de autenticação.")
    @PostMapping("/login")
    ...
    @Operation(summary = "Validar Token", description = "Valida o token JWT do Cognito.")
